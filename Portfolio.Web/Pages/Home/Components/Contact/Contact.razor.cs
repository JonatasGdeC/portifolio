...
namespace Portfolio.Web.Pages.Home.Components.Contact;
...
public partial class Contact
{
    ...
    private bool IsMissingAccessKey => string.IsNullOrWhiteSpace(value: AccessKey);
    ...
    private string StatusMessageClass => HasError ? "form-status form-status-error" : "form-status form-status-success";
}
